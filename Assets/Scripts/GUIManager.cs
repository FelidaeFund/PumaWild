...
public class GuiManager : MonoBehaviour 
{
	...
	{ 
		...
		if (levelManager.IsStalkingState() || levelManager.IsChasingState() || guiState == "guiStateLeavingGameplay") {
			...
			guiComponents.DrawLevelPanel(guiOpacity * 0.9f, levelPanelX, levelPanelY, levelPanelWidth, levelPanelHeight, true);
			...
			guiComponents.DrawStatusPanel(guiOpacity * 0.9f, statusPanelX, statusPanelY, statusPanelWidth, statusPanelHeight, true);
		}
