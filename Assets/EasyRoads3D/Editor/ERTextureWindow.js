...
var dir : DirectoryInfo= new DirectoryInfo(Directory.GetCurrentDirectory() + OQOCDDCOQO.extensionPath + "Textures/Road Textures/");

assetPath = OQOCDDCOQO.extensionPath.Substring(1, OQOCDDCOQO.extensionPath.Length - 1);
...
var road : GameObject = roadscript.ODQQOCODOC.road;
if(road != null){
