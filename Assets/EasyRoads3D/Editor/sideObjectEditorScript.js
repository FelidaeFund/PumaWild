...
{
if(target.OQCQDDCCCC.ODQQOCODOC == null || target.OQCQDDCCCC.erInit == ""){
var arr = ODCDDQQDDC.OCDOQDQCOQ(false);
target.OQCQDDCCCC.OODQOODDCO(arr, ODCDDQQDDC.OCQCOCOODC(arr), ODCDDQQDDC.ODQQOQCDOC(arr));
...
ODCDDQQDDC.OCQDOOOOOD(scr.transform, target.soIndex, target.xPosition);
RoadObjectEditorScript.OOCQCCDOQQ(scr, target.soIndex, target.objectScript);
}
EditorGUILayout.BeginHorizontal();
...
ODCDDQQDDC.OCDQDDCQOQ(scr.transform, target.soIndex, target.yPosition);
RoadObjectEditorScript.OOCQCCDOQQ(scr, target.soIndex, target.objectScript);
}
...
ODCDDQQDDC.OOODOQDCDO(scr.transform, target.soIndex, target.soAlign);
RoadObjectEditorScript.OOCQCCDOQQ(scr, target.soIndex, target.objectScript);
...
ODCDDQQDDC.ODDQCQCCCD(scr.transform, target.soIndex, target.m_distance);
RoadObjectEditorScript.OOCQCCDOQQ(scr, target.soIndex, target.objectScript);
}
}
...
ODCDDQQDDC.OQDOQOQCQQ(scr.transform, target.soIndex, target.uvInt);
RoadObjectEditorScript.OOCQCCDOQQ(scr, target.soIndex, target.objectScript);
}
if(target.uvInt == 0){
EditorGUILayout.BeginHorizontal();
...
ODCDDQQDDC.ODDDQCCDDO(scr.transform, target.soIndex, target.soUVx, target.soUVy);
RoadObjectEditorScript.OOCQCCDOQQ(scr, target.soIndex, target.objectScript);
}
EditorGUILayout.BeginHorizontal();
...
if(target.OQDCOQODOQ != "" || target.OOCCDDQQCD != ""){
EditorGUILayout.BeginHorizontal();
GUILayout.Space(20);
...
ODCDDQQDDC.OCQOCCCQOO(scr.transform, target.soIndex, target.combine);
RoadObjectEditorScript.OOCQCCDOQQ(scr, target.soIndex, target.objectScript);
}
if(target.combine){
EditorGUILayout.BeginHorizontal();
...
ODCDDQQDDC.ODDDQQDQOC(scr.transform, target.soIndex, target.weld);
RoadObjectEditorScript.OOCQCCDOQQ(scr, target.soIndex, target.objectScript);
}
}
}
...
scr = target.transform.parent.parent.gameObject.GetComponent("RoadObjectScript");
ODCDDQQDDC.HandleTangents(scr.transform, target.soIndex, target.m_tangents);
RoadObjectEditorScript.OOCQCCDOQQ(scr, target.soIndex, target.objectScript);
}
EditorGUILayout.Space();
EditorGUILayout.BeginHorizontal();
...
scr = target.transform.parent.parent.gameObject.GetComponent("RoadObjectScript");
ODCDDQQDDC.HandleCollision(scr.transform, target.soIndex, target.m_collider);
RoadObjectEditorScript.OOCQCCDOQQ(scr, target.soIndex, target.objectScript);
}
EditorGUILayout.Space();
if( target.m_go != ""){
...
EditorGUILayout.BeginHorizontal();
GUILayout.Space(20);
bo = target.ODQCCOOOCC;
target.ODQCCOOOCC = EditorGUILayout.Toggle (target.ODQCCOOOCC );
EditorGUILayout.EndHorizontal();
GUILayout.Space(-20);
GUILayout.Label(new GUIContent("         Combine instantiated objects", "Combine instantiated objects"), GUILayout.Width(250) );
if(bo != target.ODQCCOOOCC){

scr = target.transform.parent.parent.gameObject.GetComponent("RoadObjectScript");

ODCDDQQDDC.ODQQQQQQDQ(scr.transform, target.soIndex, target.ODQCCOOOCC, true);
RoadObjectEditorScript.OOCQCCDOQQ(scr, target.soIndex, target.objectScript);
}
...
ODCDDQQDDC.OQCODQOQQD(scr.transform, target.soIndex, AssetDatabase.AssetPathToGUID(AssetDatabase.GetAssetPath(target.mat)), AssetDatabase.GetAssetPath(target.mat));
RoadObjectEditorScript.OOCQCCDOQQ(scr, target.soIndex, target.objectScript);
}
EditorGUILayout.Space();
EditorGUILayout.BeginHorizontal();
...
ODCDDQQDDC.OQCOOQQDOD(scr.transform, target.soIndex);
...
ODCDDQQDDC.OCDQQQQODC(scr.transform, target.soIndex);
RoadObjectEditorScript.OOCQCCDOQQ(scr, target.soIndex, target.objectScript);
}
GUILayout.FlexibleSpace();
EditorGUILayout.EndHorizontal();
...
ODCDDQQDDC.OCCQCQCDOQ(scr.transform, target.soIndex, target.selectedRotation);
RoadObjectEditorScript.OOCQCCDOQQ(scr, target.soIndex,target.objectScript);
}
...
scr = target.transform.parent.parent.gameObject.GetComponent("RoadObjectScript");
ODCDDQQDDC.OODDDQCDCQ(scr.transform, target.soIndex, target.childOrder);
RoadObjectEditorScript.OOCQCCDOQQ(scr, target.soIndex, target.objectScript);
}
GUI.enabled = true;
so =  target.density;
...
scr = target.transform.parent.parent.gameObject.GetComponent("RoadObjectScript");
ODCDDQQDDC.OOODQDODDQ(scr.transform, target.soIndex, target.density);
RoadObjectEditorScript.OOCQCCDOQQ(scr, target.soIndex, target.objectScript);
}
...
scr = target.transform.parent.parent.gameObject.GetComponent("RoadObjectScript");
ODCDDQQDDC.ODODOCQODQ(scr.transform, target.soIndex, target.sidewaysOffset);
RoadObjectEditorScript.OOCQCCDOQQ(scr, target.soIndex, target.objectScript);
}
...
if(target.OQCQDDCCCC.objectType != 2){
ODCDDQQDDC.ODQQQQQQDQ(scr.transform, target.soIndex, target.ODQCCOOOCC, true);
RoadObjectEditorScript.OOCQCCDOQQ(scr, target.soIndex, target.objectScript);
}else if(!target.ODQCCOOOCC){
ODCDDQQDDC.ODQQQQQQDQ(scr.transform, target.soIndex, target.ODQCCOOOCC, false);
ODCDDQQDDC.UnOQDODCDQDQ(target.gameObject);
}else{
ODCDDQQDDC.ODQQQQQQDQ(scr.transform, target.soIndex, target.ODQCCOOOCC, false);
ODCDDQQDDC.OQDODCDQDQ(target.gameObject, null, null, target.OQCQDDCCCC.objectType);
}
}
...
ODCDDQQDDC.OOCQDCQCDD(target.soIndex, target.transform);
}
GUILayout.FlexibleSpace();
EditorGUILayout.EndHorizontal();
}
